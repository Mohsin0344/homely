...
class SignUpScreenOwner extends StatefulWidget {
  @override
  _SignUpScreenOwnerState createState() => _SignUpScreenOwnerState();
}

class _SignUpScreenOwnerState extends State<SignUpScreenOwner> {
  @override
