...
import 'package:homely/authenthication/users_signup/SignUpOwner.dart';
import 'package:homely/authenthication/users_signup/SignUpTenant.dart';
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Expanded(child: GestureDetector(
                                        onTap: (){
                                          Navigator.push(context, PageTransition(type: PageTransitionType.fade, duration: Duration(seconds: 1), child:SignUpScreenOwner()));
                                        },
                                        child: Image.asset("images/owner.png"))),

                                    Expanded(child: GestureDetector(
                                        onTap: (){
                                          Navigator.push(context, PageTransition(type: PageTransitionType.fade, duration: Duration(seconds: 1), child: SignUpScreenTenant()));
                                        },
