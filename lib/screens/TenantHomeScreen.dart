...
import 'package:homely/screens/NotificationScreen.dart';
import 'package:homely/screens/TenantPropertyRegistrationDetails.dart';
...
class TenantHomeScreen extends StatefulWidget {
  ...
  String Usertype=" ";
  TenantHomeScreen(this.Usertype);
  @override
                                                ...
                                                child: Align(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      Expanded(child: Align(
                                                          alignment: Alignment.bottomLeft,
                                                          child: Text(" Properties Rented",style: TextStyle(
                                                              color: Colors.black,
      ...
      children: [
        ...
        Expanded(
            ...
            child: GestureDetector(
              ...
              onTap: (){
                Navigator.push(context, PageTransition(type: PageTransitionType.bottomToTop, duration: Duration(seconds: 1), child: TenantPropertyRegistrationDetails()));
              },
              child: Container(
